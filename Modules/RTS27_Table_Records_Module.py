...
class RTS27_Table6:
    ...
    def setNumerOfOrderOrRequestForQuote (self, NUMBER_OF_ORDER_OR_REQUEST_FOR_QUOTE) :
...
class RTS27_Table4:
    ...
    def setVolumeWeightedTransactionPrice(self, VOLUME_WEIGHTED_TRANSACTION_PRICE):
        if (VOLUME_WEIGHTED_TRANSACTION_PRICE != ""):
